...
| Revista Chef & Hotel | Medio HORECA (gastronomía/hotelería) | Contacto directo | **Llamada realizada** (etapa 3) → presentando cotización | **Ramón:** presentar Tarifario Socio `SPL-PROP-2026-001` al cliente. Confirmar tratamiento de IVA antes de que salga. Al enviar → mover a etapa 4. | 14 ago 2026 (reunión) | ⚠️ **Caso especial: SOCIO/CANAL, no cliente final.** Terceriza paid media + SEO/AEO para su cartera HORECA (revende con su margen). **Modelo socio/canal APROBADO por Ramón (14-ago)** — razón: plasticidad de la empresa + ganar experiencia. **Precios FINALES = los del tarifario** (competitivos, como presentados). Producidos y commiteados: estudio de posicionamiento, mini-diagnóstico `SPL-DIAG-2026-002`, Tarifario Socio `SPL-PROP-2026-001`. **Guardrail operativo:** el modelo de volumen convive con la regla de capacidad 1–2 clientes (§7) — vigilar entrega vs. capacidad; §7 a revisar. Pendiente antes de enviar: **IVA**. |
