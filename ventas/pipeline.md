...
| Revista Chef & Hotel | Medio HORECA (gastronomía/hotelería) | Contacto directo | **Llamada realizada** (etapa 3) → preparando propuesta | **Ramón:** decidir modelo (¿white-label/socio sí o no?) + precios finales + tratamiento IVA. Antes de comprometer precios: validar con Nora costo real de entrega/capacidad. Luego enviar Tarifario Socio SPL-PROP-2026-001. | 14 ago 2026 (reunión) | ⚠️ **Caso especial: SOCIO/CANAL, no cliente final.** Quiere tercerizar paid media + SEO/AEO para su cartera de clientes HORECA (revende con su margen). Producidos y commiteados: estudio de posicionamiento, mini-diagnóstico `SPL-DIAG-2026-002`, Tarifario Socio `SPL-PROP-2026-001` (**borrador, NO enviado**). **Decisión de modelo pendiente** — el modelo de volumen choca con la regla de capacidad 1–2 clientes de la estrategia §7; requiere fundar el frente (troncal) + datos de Nora antes de comprometerse. |
