...
- Oferta de entrada: mini-diagnóstico gratis de 1 página en **menos de 24 h** (actualizado 29 jul 2026; antes decía 48 h) → llamada de 20 min. Sin precios públicos (auditoría desde $350k CLP, retainer desde $500k/mes — solo se conversan en llamada).
...
- **Tipografías:** ⚠️ **SUPERADO — no seguir esta línea.** El brief decía «Fraunces (títulos) + Inter (texto)»; el sitio **nunca** usó Fraunces (corregido en el manual v1.2, 8 jul 2026) y hoy la marca es **Gabarito** en titulares, con el cuerpo partido por medio (Manrope en el sitio, Inter en piezas renderizadas). Fuente de verdad: `marketing/brand/manual-de-marca.md` §05.
