...
- [x] [TÚ] Instagram: carrusel publicado ✅ 16 jul — retoma la cadencia tras la pausa desde semana 1
  - **Handoff 21 jul:** 2 posts únicos listos (24 y 31 jul). Primeros formatos nuevos preparados: Reel (3 clips Higgsfield + 5 overlays transparentes + guion, a montar en CapCut), 4 Stories de interacción, 1 post de contraste con foto de fondo. Créditos Higgsfield usados: ~24 (día del Reel), saldo ~975/1000 — vigilar consumo si se repite el ritmo.
...
- [x] [TÚ] **Encender Google Ads** — adelantado, activado 14 jul (antes de lo previsto). Campaña de Búsqueda, $1.500 CLP/día (~$45k/mes), 4 keywords en frase exacta («auditoría SEO», «consultor SEO técnico», «aparecer en ChatGPT empresa», «SEO clínicas dentales»), Display y Socios de búsqueda desactivados, 4 sitelinks, URL final con UTM (`utm_source=google&utm_medium=cpc&utm_campaign=auditoria-seo`). Verificado campo por campo contra los defaults de Google (que intentaron colar Máximo rendimiento, Display, y presupuesto ~15x más alto).
  ...
  - **Nota 23 jul — revisión semanal (handoff de la sesión de Google Ads, `marketing/encargos-otras-sesiones/paid-media-revision-2026-07-23.md` — reconciliación parcial, ver nota de sincronización abajo):**
    - Los 4 títulos agregados el 20 jul **no habían quedado guardados** en la cuenta — se detectó y corrigió en esta revisión. Señal de que revisar un cambio de anuncio no basta con verlo editado, hay que confirmar que el "Guardar" se aplicó de verdad.
    - Calidad del anuncio bajó a "Buena" (no "Excelente" como se registró el 20 jul) — recuperarla requeriría sumar los 2 sitelinks opcionales restantes o sacar alguna fijación. Decisión pendiente de Ramón sobre si forzarlo.
    - **Sigue sin conversiones:** 0 entre el 13 y el 23 jul, 16 clics acumulados (~1 clic/día). A este ritmo, la decisión de Semana 12 (≥2 mini-diagnósticos originados en ads) se acerca con muy poca data — riesgo real de llegar a esa fecha sin señal suficiente para un veredicto sólido.
    - IA Max y la auto-aplicación de recomendaciones de Google, confirmados apagados.
    - **Pendiente de verificar (no confirmado por la sesión troncal — la rama del handoff no está pusheada a `origin`, ver nota abajo):** el detalle exacto de que el cambio de títulos quedó guardado (fila "Y 6 más" → "Y 12 más" = 15 títulos) — se registrará cuando se pueda leer el archivo fuente.
