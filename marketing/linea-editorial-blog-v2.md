...
| 6 | Anatomía de una auditoría real, hallazgo por hallazgo | Evidencia (caso) | hallazgo · antes · después | ANONIMIZADO (decisión Ramón 28-ago: caso con nombre en reserva hasta ≥3 clientes con datos verificables) | Eje + web |
