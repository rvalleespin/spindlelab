...
Mazo de 18 láminas más un anexo para presentar SpindleLab a gerencias de marketing y de negocio, pensado
...
| `presentacion-marca.pdf` | Render listo para enviar (Chrome headless, 19 páginas: 18 láminas + anexo). Regenerar tras cada cambio del HTML. |
...
| 9 a 12 | 9, 10 | El mapa de posicionamiento (muestra frente a promete, IA como eje frente a IA como módulo) y los precios con nombre. Si preguntan por una agencia en concreto, ir al anexo (19). No comentar a los competidores; solo los hechos de la casilla. |
...
**Plazos que el mazo compromete (v2):** diagnóstico 24 h · línea base y plan 5 días hábiles · implementación 2 a 3 semanas · monitoreo quincenal. El sitio quedó alineado en esta misma rama (/metodo/, FAQ de la auditoría y entrega de visibilidad en IA); sale en vivo cuando la rama se mergee a main.
...
- [ ] Exportar el PDF de nuevo y mirar las 19 páginas.
