...
## Semana 5 (4–10 ago) — arranque con video
...
**Reuso Meta Ads:** sí, mensaje corto. **Video:** se puede grabar como "hice la prueba" o reusar el estilo del Reel de julio. **Personal comenta/comparte el mismo día** (convención 21 jul).
...
### Mié 5 ago · LinkedIn personal
**Ángulo:** la brecha entre reputación offline y lo que la IA puede leer.

> Hay empresas chilenas con 30 años de trayectoria que, para ChatGPT, casi no existen.
>
...
## Semana 6 (11–17 ago) — profundidad de método

> **Condicional (del encargo):** si para esta semana Bernardo ya dio permiso de caso público, estrenar el primer post con nombre real (Formato 5) reemplazando uno de los dos de empresa. Hoy nadie ha dado permiso, así que van los genéricos.
...
### Mié 12 ago · LinkedIn personal
**Ángulo:** el problema de identidad frente a la IA (colisión de marca con homónimos).

> Encontré algo casi cómico revisando empresas chilenas: varias tienen un problema de identidad frente a la IA.
>
...
## Semana 7 (18–24 ago) — el momento del checkpoint (día 45)

> **Condicional (del encargo):** si al día 45 hay cliente cerrado o pipeline real, el tono puede apoyarse en eso (sin prometer de más). Si no hay avance, mantener autoridad técnica, nunca urgencia ni desesperación. Los textos default de abajo funcionan en ambos escenarios.
...
### Mié 19 ago · LinkedIn personal
**Ángulo:** el checkpoint del mes en tono de autoridad, no de urgencia.

> Un mes revisando sitios chilenos me dejó una conclusión clara: la mayoría de las empresas que miré tienen un problema de visibilidad frente a la IA, y en casi todos los casos es técnico y arreglable, no de fondo.
>
...
## Semana 8 (25–31 ago) — cierre de mes (precios / objeciones)

> **Condicional (del encargo):** si ya hay datos del Pixel/Meta Ads o de la evaluación de Google Ads de esta semana, conectar el contenido con esos resultados, sin prometer de más. Los textos default no dependen de eso.
...
**Reuso Meta Ads:** sí (funciona como ad de oferta).
...
### Mié 26 ago · LinkedIn personal
**Ángulo:** reflexión de cierre de mes.

> Cierro agosto con una idea que se me hizo más clara revisando sitios todo el mes: la visibilidad en IA no se trata de gritar más fuerte, sino de ser entendible.
>
...
## Resumen para la sesión troncal (registrar en plan-operativo-90-dias.md)

| Fecha | Día | Canal | Formato | Ángulo |
|---|---|---|---|---|
| 4 ago | mar | Empresa | Evidencia / video | robots.txt bloquea a la IA (hallazgo estrella) |
| 5 ago | mié | Personal | Storytelling | reputación offline vs lo que lee la IA |
| 6 ago | jue | Empresa | Detrás del método | sitio JS que llega vacío a los bots |
| 11 ago | mar | Empresa | Detrás del método | los 5 chequeos de una auditoría |
| 12 ago | mié | Personal | Storytelling | colisión de marca con homónimos |
| 13 ago | jue | Empresa | Detrás del método | schema genérico / fundador ausente |
| 18 ago | mar | Empresa | Mito vs realidad | rankear en Google ≠ aparecer en IA |
| 19 ago | mié | Personal | Storytelling | checkpoint en tono de autoridad |
| 20 ago | jue | Empresa | Evidencia | autoridad/prensa no conectada (E-E-A-T) |
| 25 ago | mar | Empresa | Precios/objeciones | "¿cuánto cuesta arreglarlo?" |
| 26 ago | mié | Personal | Storytelling | cierre: ser entendible > gritar más |
| 27 ago | jue | Empresa | Cierre honesto | la promesa que NO hago |

**Condicionales a vigilar:** (1) permiso de caso de Bernardo → estrenar Formato 5 en semana 6; (2) estado del día 45 → ajustar tono semana 7; (3) datos de Pixel/Ads → conectar en semana 8.
