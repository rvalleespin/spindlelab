...
`https://verificaycumple.pages.dev` (8-sep-2026). Camino B, lanzamiento liviano, `.cl` sigue
pendiente para cuando genere ingresos. Falta: la página de enlace cruzado en `spindlelab.cl`
y que Cata publique el post (ver §8, ya no está bloqueado por el deploy).
